...
const ServiceComponent = ({ props }) => {
  ...
  <div className="relative m-0 overflow-hidden text-gray-700 bg-transparent rounded-none shadow-none bg-clip-border h-[250px]">
    <img
      src={props.icon}
  ...
  <div className="p-6">
    <h4 className="block font-sans text-xl antialiased font-[600] leading-snug tracking-normal text-blue-gray-900">
      {props.title}
    </h4>
    <p className="block mt-3 font-sans text-l antialiased font-normal leading-relaxed text-gray-700">
      {props.description}
    </p>
  </div>
